<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Biljeter.aspx.cs" Inherits="Nti_Website.Biljeter" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Biljeter</title>
      <style type="text/css">
            ...
            <div class="row">
                <div class="col-12">
                    <header class="entry-header">
                        <h1 class="entry-title">Biljetter</h1>
                    </header>
                </div>
            </div>
        </div>
            ...
            <div class="container">
               ...
               <div class="row text-center">
                ...
                <p>
                     ...
                     Biljetter till NTIG Awards kommer att finnas på vårt kansli.<br /> Elever går naturligtvis utan kostnad men ska hämta biljett åt sig själv.<br />
                    Ett begränsat antal biljetter finns till försäljning till släkt och vänner för 50kr. styck.<br />Barn under 10 år behöver ingen biljett om de går i vuxet sällskap.<br />
                    Var hämtad biljett ingår i ett lotteri med fina vinster som lottas ut under galan.<br /><strong>OBS!</strong>  Endast förhandsköp via skolan från 21 maj till tisdag den 5 juni!
                </p>
                   <p><img src="images/biljett.png" width="100%"/></p>
